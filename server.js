...
app.post('/api/eleves/importer', requireAuth, async (req, res) => {
    ...
    eleves.forEach((e, i) => {
        ...
        valides.push({
            matricule, nom: e.nom, prenoms: e.prenoms, sexe: e.sexe,
            date_naissance: normaliserDateNaissance(e.date_naissance), lieu_naissance: e.lieu_naissance,
            nationalite: e.nationalite, classe: e.classe, statut: e.statut || 'NAFF',
            qualite: e.qualite, lv2: e.lv2 || 'N/A', regime: e.regime,
            nom_pere: e.nom_pere, prenoms_pere: e.prenoms_pere, contact_pere: e.contact_pere,
            nom_mere: e.nom_mere, prenoms_mere: e.prenoms_mere, contact_mere: e.contact_mere
        });
    });
