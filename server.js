        ...
        for (const e of eleves) {
            try {
                ...
                `, [
                    ...
                    e.lieu_naissance, e.nationalite, e.classe, 'PRE_INSCRIT', e.qualite,
...
app.post('/api/eleves/inscrire', async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query(`
            ...
            VALUES ($1,$2,$3,$4,$5,$6,$7,$8,'INSCRIT',$10,$11,$12,$13,$14,$15,$16,$17,$18,NOW())
            ON CONFLICT (matricule) DO UPDATE SET
                ...
                statut = 'INSCRIT', qualite = EXCLUDED.qualite, lv2 = EXCLUDED.lv2,
        ...
        `, [
            ...
            data.lieu_naissance, data.nationalite, data.classe, 'INSCRIT', data.qualite,
